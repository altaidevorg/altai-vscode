# Remaining work plan — pure chrome through A6.243
...
Pure dual-chrome extraction continues (**A6.140–A6.243**: instruction prefix, plan review history rows). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.243 on `altai-app` main (through plan review history row projection) |

# Remaining work plan — pure chrome through A6.218
...
Pure dual-chrome extraction continues (**A6.140–A6.218**: session title map, ops templates, create readiness / auto model pick chrome. This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.218 on `altai-app` main (through ops create readiness + auto model pick) |

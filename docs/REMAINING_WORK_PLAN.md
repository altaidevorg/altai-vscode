# Remaining work plan — pure chrome through A6.254
...
Pure dual-chrome extraction continues (**A6.140–A6.254**: task permission mode short label). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.254 on `altai-app` main (through task permission mode short label) |

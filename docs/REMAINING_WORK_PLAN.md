# Remaining work plan — pure chrome through A6.244
...
Pure dual-chrome extraction continues (**A6.140–A6.244**: agent switcher partition; plan apply feedback next). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.244 on `altai-app` main (through agent switcher list partition) |

# Remaining work plan — pure chrome through A6.197
...
Pure dual-chrome extraction continues (**A6.140–A6.197**: session mutate/hydrate/title derive, transcript cut, slash toasts). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.197 on `altai-app` main (through session ops + Nth-user cut) |

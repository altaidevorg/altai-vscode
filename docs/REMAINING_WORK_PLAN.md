# Remaining work plan — pure chrome through A6.176
...
Pure dual-chrome extraction continues (**A6.140–A6.176**: model routing, native
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.176 on `altai-app` main (through agent name match, plan-mode tail, and body bytes) |

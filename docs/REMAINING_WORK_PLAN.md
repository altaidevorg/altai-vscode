# Remaining work plan — pure chrome through A6.234
...
Pure dual-chrome extraction continues (**A6.140–A6.234**: session history items, context source detail labels). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.234 on `altai-app` main (through task context source detail labels) |

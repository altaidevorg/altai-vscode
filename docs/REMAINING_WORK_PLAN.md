# Remaining work plan — pure chrome through A6.257
...
Pure dual-chrome extraction continues (**A6.140–A6.257**: composer stop/send control labels). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.257 on `altai-app` main (through composer stop/send control labels) |

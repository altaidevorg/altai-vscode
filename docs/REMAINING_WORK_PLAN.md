# Remaining work plan — pure chrome through A6.214
...
Pure dual-chrome extraction continues (**A6.140–A6.214**: session history snippet + task runs status/filter chrome). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.214 on `altai-app` main (through Task Runs filter/group chrome) |

# Remaining work plan — pure chrome through A6.255
...
Pure dual-chrome extraction continues (**A6.140–A6.255**: desktop composer placeholder/follow-up chrome). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.255 on `altai-app` main (through desktop composer placeholder/follow-up chrome) |

# Remaining work plan — pure chrome through A6.231
...
Pure dual-chrome extraction continues (**A6.140–A6.231**: selected-context compose, waiting job state). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.231 on `altai-app` main (through waiting job state helpers) |

# Remaining work plan — pure chrome through A6.256
...
Pure dual-chrome extraction continues (**A6.140–A6.256**: composer context menu and tool titles). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.256 on `altai-app` main (through composer context menu and tool titles) |

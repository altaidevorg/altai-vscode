# Remaining work plan — pure chrome through A6.252
...
Pure dual-chrome extraction continues (**A6.140–A6.252**: AI status-bar control titles). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.252 on `altai-app` main (through AI status-bar control titles) |

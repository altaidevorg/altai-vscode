# Remaining work plan — pure chrome through A6.238
...
Pure dual-chrome extraction continues (**A6.140–A6.238**: automation form parse, chat tabs from open ids). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.238 on `altai-app` main (through chat tabs from open session ids) |

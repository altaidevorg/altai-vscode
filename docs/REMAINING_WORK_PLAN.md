# Remaining work plan — pure chrome through A6.247
...
Pure dual-chrome extraction continues (**A6.140–A6.247**: model dropdown trigger/empty copy). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.247 on `altai-app` main (through model dropdown trigger/empty copy) |

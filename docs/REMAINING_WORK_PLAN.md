# Remaining work plan — pure chrome through A6.248
...
Pure dual-chrome extraction continues (**A6.140–A6.248**: task queue surface subtitle). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.248 on `altai-app` main (through task queue surface subtitle) |

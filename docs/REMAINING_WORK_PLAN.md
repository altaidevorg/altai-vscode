# Remaining work plan — pure chrome through A6.201
...
Pure dual-chrome extraction continues (**A6.140–A6.201**: session ops, env blocks, slash prompts, agent meta projection). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.201 on `altai-app` main (through env blocks, slash prompts, run meta) |

# Remaining work plan — pure chrome through A6.227
...
Pure dual-chrome extraction continues (**A6.140–A6.227**: chat history search, catalog id lookup). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.227 on `altai-app` main (through catalog id lookup + model label) |

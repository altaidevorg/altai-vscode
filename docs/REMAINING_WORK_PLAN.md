# Remaining work plan — pure chrome through A6.246
...
Pure dual-chrome extraction continues (**A6.140–A6.246**: task context availability flags). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.246 on `altai-app` main (through task context availability flags) |

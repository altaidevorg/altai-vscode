# Remaining work plan — pure chrome through A6.241
...
Pure dual-chrome extraction continues (**A6.140–A6.241**: automation list subtitle, composer picker filters). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.241 on `altai-app` main (through composer snippet/file picker filters) |

# Remaining work plan — pure chrome through A6.249
...
Pure dual-chrome extraction continues (**A6.140–A6.249**: session id list projection). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.249 on `altai-app` main (through session id list projection) |

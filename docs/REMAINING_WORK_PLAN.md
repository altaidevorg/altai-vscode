# Remaining work plan — pure chrome through A6.245
...
Pure dual-chrome extraction continues (**A6.140–A6.245**: plan apply feedback chrome). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.245 on `altai-app` main (through plan apply feedback chrome) |

# Remaining work plan — pure chrome through A6.250
...
Pure dual-chrome extraction continues (**A6.140–A6.250**: run inspector overview copy). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.250 on `altai-app` main (through run inspector overview copy) |

# Remaining work plan — pure chrome through A6.259
...
Pure dual-chrome extraction continues (**A6.140–A6.259**: chat history popover chrome). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.259 on `altai-app` main (through chat history popover chrome) |

# Remaining work plan — pure chrome through A6.229
...
Pure dual-chrome extraction continues (**A6.140–A6.229**: task run outcome counts, task run card labels). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.229 on `altai-app` main (through task run card tokens/skills/name labels) |

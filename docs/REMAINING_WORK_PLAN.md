# Remaining work plan — pure chrome through A6.258
...
Pure dual-chrome extraction continues (**A6.140–A6.258**: automation create form status/submit). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.258 on `altai-app` main (through automation create form status/submit) |

# Remaining work plan — pure chrome through A6.251
...
Pure dual-chrome extraction continues (**A6.140–A6.251**: run recovery title/detail/steer copy). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.251 on `altai-app` main (through run recovery title/detail/steer copy) |

# Remaining work plan — pure chrome through A6.225
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.225 on `altai-app` main (through task context path merge + bot title strip) |

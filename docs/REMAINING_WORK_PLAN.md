# Remaining work plan — pure chrome through A6.240
...
Pure dual-chrome extraction continues (**A6.140–A6.240**: run inspector activity, automation list subtitle). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.240 on `altai-app` main (through automation list/create subtitle copy) |

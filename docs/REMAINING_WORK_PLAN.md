# Remaining work plan — pure chrome through A6.242
...
Pure dual-chrome extraction continues (**A6.140–A6.242**: composer picker filters, instruction prefix). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.242 on `altai-app` main (through composer instruction prefix helper) |

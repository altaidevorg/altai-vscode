# Remaining work plan — pure chrome through A6.235
...
Pure dual-chrome extraction continues (**A6.140–A6.235**: context source labels, model dropdown filter). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.235 on `altai-app` main (through model dropdown filter + fav/recent partition) |

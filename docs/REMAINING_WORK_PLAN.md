# Remaining work plan — pure chrome through A6.226
...
Pure dual-chrome extraction continues (**A6.140–A6.226**: context path chrome, chat history session search). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.226 on `altai-app` main (through chat history session search filter) |

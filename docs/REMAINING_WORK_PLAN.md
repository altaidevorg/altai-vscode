# Remaining work plan — pure chrome through A6.165
...
Pure dual-chrome extraction continues (**A6.140–A6.165**: model routing, native
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.165 on `altai-app` main (through native message id + backend transcript map) |

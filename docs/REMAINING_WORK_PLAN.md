# Remaining work plan — pure chrome through A6.230
...
Pure dual-chrome extraction continues (**A6.140–A6.230**: task run card labels, selected-context compose). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.230 on `altai-app` main (through task selected-context compose blocks) |

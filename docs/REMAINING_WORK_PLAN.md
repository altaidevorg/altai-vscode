# Remaining work plan — pure chrome through A6.161
...
Pure dual-chrome extraction continues (**A6.140–A6.161**: model routing, native
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.161 on `altai-app` main (through isanagent target chrome + provider keys) |

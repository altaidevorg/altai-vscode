# Remaining work plan — pure chrome through A6.212
...
Pure dual-chrome extraction continues (**A6.140–A6.212**: automation schedule/filter/helpers + session history snippet chrome). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.212 on `altai-app` main (through session history snippet + content presence) |

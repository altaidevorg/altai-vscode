# Remaining work plan — pure chrome through A6.239
...
Pure dual-chrome extraction continues (**A6.140–A6.239**: chat tabs from open ids, run inspector activity). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.239 on `altai-app` main (through run inspector activity filter + todo count) |

# Remaining work plan — pure chrome through A6.163
...
Pure dual-chrome extraction continues (**A6.140–A6.163**: model routing, native
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.163 on `altai-app` main (through path join + todo_write item parse) |

# Remaining work plan — pure chrome through A6.253
...
Pure dual-chrome extraction continues (**A6.140–A6.253**: history toggle and mini-conversation titles). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.253 on `altai-app` main (through history toggle and mini-conversation titles) |

# Remaining work plan — pure chrome through A6.202
...
Pure dual-chrome extraction continues (**A6.140–A6.202**: env blocks, slash prompts, agent meta, compaction toast). This document sequences **everything still required**
...
| Track | State |
|---|---|
| Pure chrome `agent-ui` libs | ~A6.140–A6.202 on `altai-app` main (through env blocks, slash prompts, run meta, compaction toast) |
